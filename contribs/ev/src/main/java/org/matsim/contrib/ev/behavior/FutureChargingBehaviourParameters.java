...
/**
 * Container for all configurable parameters used by {@link FutureChargingBehaviourModel}.
 * <p>
 * This is intentionally a parallel copy of {@link ChargingBehaviourParameters}: the future
 * H/W/D/F charging-access model (paper 3) evolves independently of the legacy charging-behaviour
 * model, so the two parameter containers are kept apart to allow either model to change
 * without affecting the other.
 */
public final class FutureChargingBehaviourParameters {
	...
	private FutureChargingBehaviourParameters() {
	}

	/**
	 * Creates parameters whose default values reflect the future H/W/D/F model defaults from
	 * paper 3 (Lavieri & de Oliveira preference data and Melbourne uptake calibration).
	 */
	public static FutureChargingBehaviourParameters createDefault() {
		FutureChargingBehaviourParameters parameters = new FutureChargingBehaviourParameters();
		parameters.learningRate = 0.2;
		parameters.acReferencePower = 22_000.0;
		parameters.dcfcReferencePower = 250_000.0;

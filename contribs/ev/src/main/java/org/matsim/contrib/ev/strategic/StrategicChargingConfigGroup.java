...
public class StrategicChargingConfigGroup extends ReflectiveConfigGroupWithConfigurableParameterSets {
	...
	public StrategicChargingConfigGroup() {
		...
		addDefinition(EmptyChargingPlanInnovator.Parameters.SET_NAME, //
				EmptyChargingPlanInnovator.Parameters::new, //
				() -> innovation instanceof EmptyChargingPlanInnovator.Parameters
						? (EmptyChargingPlanInnovator.Parameters) innovation
						: null,
				i -> innovation = (EmptyChargingPlanInnovator.Parameters) i);
	}
